...
<body>
	<div class="container">
		<div style="width: 100%; display: flex; justify-content: right">
			<a class="btn btn-info" href="view/${u.id}"
				style="margin-right: 10px;">내 정보</a>
			<button type="button" class="btn btn-warning"
				style="margin-right: 10px;"
				onclick="location.href='../login/logout'">로그아웃</button>
			<button type="button" class="btn btn-primary"
				onclick="location.href = 'list_cat1'">과일별</button>
		</div>
		<h1 class="title">Food List</h1>
		<br>
		<div style="display: flex; justify-content: center;">
			<div class="btn-group" role="group" aria-label="Basic example">
				<button id="type_button_7" type="button"
					class="btn btn-success active" onclick="type_filter(7);">전체</button>
				<button id="type_button_0" type="button" class="btn btn-success"
					onclick="type_filter(0);">비건</button>
				<button id="type_button_1" type="button" class="btn btn-success"
					onclick="type_filter(1);">락토 베지테리언</button>
				<button id="type_button_2" type="button" class="btn btn-success"
					onclick="type_filter(2);">오보 베지테리언</button>
				<button id="type_button_3" type="button" class="btn btn-success"
					onclick="type_filter(3);">락토 오보 베지테리언</button>
				<button id="type_button_4" type="button" class="btn btn-success"
					onclick="type_filter(4);">페스코 베지테리언</button>
				<button id="type_button_5" type="button" class="btn btn-success"
					onclick="type_filter(5);">폴로 베지테리언</button>
				<button id="type_button_6" type="button" class="btn btn-success"
					onclick="type_filter(6);">플렉시테리언</button>
			</div>
		</div>
		<br> <input type="text" id="myInput" onkeyup="searchFunction()"
			placeholder="이름/칼로리/종류/설명 검색" title="검색하기">
